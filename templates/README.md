...
Copyable starting points. Instantiate by copying, never by writing from a blank page.
...
| `FINDINGS.md` | the host system root | whoever notices, and nobody rules in it |
...
Two of these are read by something with no location. Every path in a `CONTRACT.md` or a card
resolves from the folder the agent is put in, and never from where you happened to be standing
when you wrote it.
