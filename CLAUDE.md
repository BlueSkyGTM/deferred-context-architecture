...
3. **Silos are independent.** One-way references only: silo to well / `_core` / `meta-seams`. Never
   silo to silo; never well to silo. This is what lets any pillar be built in any order.
