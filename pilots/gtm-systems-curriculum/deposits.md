...
- type:           <docs-site | web-article | video | pdf-or-office | other>
...
The left column matches the `type:` enum in the deposit register above, exactly.
| Deposit type (`type:`) | Extractor (from tooling.md) |
|---|---|
| docs-site | docs-site skill |
| web-article | article-extractor |
| video | youtube-transcript |
| pdf-or-office | markitdown |
