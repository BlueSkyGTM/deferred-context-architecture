...
Pull the slice of the well this silo needs, and only that. Deferred: draw what this run needs, not the
whole well. See `../../../../_core/well-contract.md` and `../../../../_core/deferral.md`.
